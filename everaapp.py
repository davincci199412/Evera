...
import evera  # noqa
import evera.argsparser as argsparser  # noqa
from evera.clientconfigdescriptor import ClientConfigDescriptor, \
    ConfigApprover  # noqa
from evera.config.environments import set_environment  # noqa
from evera.core import variables  # noqa
from evera.core.common import install_reactor  # noqa
from evera.core.simpleenv import get_local_datadir  # noqa

logger = logging.getLogger('everaapp')  # using __name__ gives '__main__' here
...
@click.option('--password', default=None,
              help="Password to unlock Evera. This flag should be mostly used "
              "during development as it's not a safe way to provide password")
@click.option('--accept-terms', is_flag=True, default=False,
              help="Accept Evera terms of use. This is equivalent to calling "
                   "`everacli terms accept`")
...
@click.option('--log-level', default=None,
              ...
              help="Change level for Evera loggers and handlers")
...
def log_ethereum_chain():
    from evera.config.active import EthereumConfig
...
def generate_rpc_certificate(datadir: str):
    ...
    from evera.rpc.common import CROSSBAR_DIR
