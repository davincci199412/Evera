package com.evera.core.replicate;

import com.evera.common.chain.ChainContribution;
...
import com.evera.core.chain.Web3jService;
...
import static com.evera.common.replicate.ReplicateStatus.CONTRIBUTED;
import static com.evera.common.replicate.ReplicateStatus.REVEALED;
...
public class ReplicateServiceTests {
    ...
    public void shouldUpdateReplicateStatus(){
        ...
        when(everaHubService.getChainContribution(CHAIN_TASK_ID, WALLET_WORKER_1)).thenReturn(Optional.of(ChainContribution.builder()
    ...
    public void shouldNotNotUpdateReplicateStatusSinceCannotGetContribution() {
        ...
        when(web3jService.isBlockAvailable(anyLong())).thenReturn(true);
        when(everaHubService.doesWishedStatusMatchesOnChainStatus(any(), any(), any())).thenReturn(true);
        when(everaHubService.getChainContribution(CHAIN_TASK_ID, WALLET_WORKER_1)).thenReturn(Optional.empty());
        when(replicatesRepository.save(replicatesList)).thenReturn(replicatesList);
